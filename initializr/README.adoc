= Example of Customizing Spring Initializr for organizational needs

To contribute to the main Spring Initializr project go here: https://github.com/spring-io/initializr
